...
def celery():
    ...
    install_requirements()
    migrate()
    local('celery worker -A gehealthcare -B -l INFO --concurrency=2')
...
def dev():
    ...
    env.remote = 'origin'
    env.branch = 'master'
    env.hosts = ['dev.gehealthcare.com']
    env.dotenv_path = '/home/ubuntu/dev/gehealthcare/.env'
...
def qa():
    ...
    env.remote = 'origin'
    env.branch = 'qa'
    env.hosts = ['qa.gehealthcare.com']
    env.dotenv_path = '/home/ubuntu/qa/gehealthcare/.env'
    env.config_setter = fab.run
...
def prod():
    ...
    env.remote = 'origin'
    env.branch = 'prod'
    env.hosts = ['prod.gehealthcare.com']
    env.dotenv_path = '/home/ubuntu/prod/gehealthcare/.env'
    env.config_setter = fab.run
