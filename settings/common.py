"""Django settings for gehealthcare project.
...
APPS_DIR = ROOT_DIR.path('gehealthcare')
...
# ------------------------------------------------------------------------------
REST_FRAMEWORK = {
    'DEFAULT_PAGINATION_CLASS': 'gehealthcare.base.api.pagination.PageNumberPagination',
    'PAGE_SIZE': 30,
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': (
        ...
        'gehealthcare.users.auth.backends.UserTokenAuthentication',

        # Mainly used for api debug.
        'rest_framework.authentication.SessionAuthentication',
    ),
    'EXCEPTION_HANDLER': 'gehealthcare.base.exceptions.exception_handler',
}
...
SITE_NAME = env("SITE_NAME", default='gehealthcare')
...
FRONTEND_SITE_NAME = env('FRONTEND_SITE_NAME', default='gehealthcare')
...
# URL CONFIGURATION
# ------------------------------------------------------------------------------
ROOT_URLCONF = 'gehealthcare.urls'
...
DEFAULT_FROM_EMAIL = env('DEFAULT_FROM_EMAIL',
                         default='shubhambansal <shubhambansal17@hotmail.com>')
EMAIL_SUBJECT_PREFIX = env('EMAIL_SUBJECT_PREFIX', default='[gehealthcare] ')
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres://localhost/gehealthcare'),
}
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'context_processors': [
                'gehealthcare.base.context_processors.site_settings',
...
CSRF_FAILURE_VIEW = 'gehealthcare.base.views.csrf_failure'
...
def get_release():
    ...
    import os
    import raven
    release = gehealthcare.__version__
    try:
