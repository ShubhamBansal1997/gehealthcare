...
import logistic_regression_tfidf
# import test
import os
import sys
...
def results():
        ...
        length = logistic_regression_tfidf.predict(input_seq)
        seq=[]
       ...
       # emailID = request.form['email']
        ...
        return render_template('results_page.html', input_seq=input_seq, length=seq,lab_text='51067', diagnosis_text= 'V1301')
...
def get_info_for_mail(lab_tests, diagnoses, prediction):
    ...
    for diagnosis in diagnoses:
        diag_dict[diagnopsis] = diag_codes[diagnosis]
